...
main: 
	...
	readloop: #read line from dictionary, compare with user input. repeat.	
		...
		addiu $a1, $0, 0x10040000 #the string being read is stored on the stack. why not?
		jal readfile #reads a line from the file 
	j DIE

readfile: #reads line from a file. arguments: a0= file descriptor a1=address of input buffer.  returns v0, the file status
